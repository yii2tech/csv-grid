...
/**
 * DataColumn is the default column type for the {@see CsvGrid} widget.
 *
...
{
    /**
     * @var string the attribute name associated with this column. When neither {@see content} nor {@see value}
    ...
    public $attribute;
    /**
     * @var string label to be displayed in the {@see header} and also to be used as the sorting
     ...
     * `['date', 'php:Y-m-d']`). Supported formats are determined by the {@see CsvGrid::$formatter} used by
     * the {@see CsvGrid}. Default format is "text" which will format the value as an HTML-encoded plain text when
     * {@see \yii\i18n\Formatter} is used as the {@see CsvGrid::$formatter} of the CsvGrid.
     */
    public $format = 'raw';
